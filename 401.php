...
<html lang="en">
    ...
    <body>
        <?php include 'nav.php'?>
        <script>
          document.getElementById("navHeading").innerHTML = "401";
        ...
        <div class="container marketing">
            ...
            <div class="row featurette">
                <div class="col-md-7 order-md-2">
                  <h1> ERROR: 401<br>Unauthorized</h1> <br>
                ...
                <div class="col-md-5 order-md-1" align="center">
                    <img class="featurette-image img-fluid mx-auto" style="width: 100% height: 500px;" src="authority.png" data-holder-rendered="true">
                </div>
            </div>
            <!-- FOOTER -->
