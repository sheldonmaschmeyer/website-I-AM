        ...
        switch ($token->type) {
            ...
            case Token::OPERATOR:
                if ($token->value == self::OP_LEFT_BRACKET) {
                    $value = $this->fn($this->objectIndex($this->fn($this->scope->data)));
                } elseif ($token->value == self::OP_DOT) {
                    $value = $this->peek() ? $this->fn($this->objectMember($this->fn($this->scope->data))) : $this->fn($this->scope->data);
                } else {
